  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        <button type="button" onClick={() => triggerFile("photo")} disabled={uploading}
        ...
        <button type="button" onClick={() => triggerFile("voice")} disabled={uploading}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-navy/15 text-[12px] font-semibold text-ink-mid hover:border-amber/40 hover:text-amber transition-colors disabled:opacity-40">
          <Mic size={14} strokeWidth={1.5} /> Voice note
        </button>
        <button type="button" onClick={() => triggerFile("video")} disabled={uploading}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-navy/15 text-[12px] font-semibold text-ink-mid hover:border-amber/40 hover:text-amber transition-colors disabled:opacity-40">
      ...
      {uploading && (
        <p className="text-xs text-amber font-semibold mb-2">Uploading...</p>
      )}
