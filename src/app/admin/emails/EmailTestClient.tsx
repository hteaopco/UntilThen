...
const TEMPLATES: EmailTemplate[] = [
  ...
  {
    id: "vault-invite",
    name: "#20 Vault Contributor Invite",
    subject: "Add your message for Olivia.",
    bodyPreview: "You've been invited to contribute to a time capsule for Olivia. Jett invited you to be part of this. A message. A memory.",
    trigger: "Vault contributor invited",
    frequency: "On event",
    funnel: "Acquisition",
  },
  {
    id: "vault-resend",
    name: "#21 Resend Vault Invite",
    subject: "Add your message for Olivia.",
    bodyPreview: "You've been invited to contribute to a time capsule for Olivia. A message. A memory. Something they'll open and experience in the future.",
    trigger: "Re-send vault contributor invite",
    frequency: "On event",
    funnel: "Acquisition",
  },
];
