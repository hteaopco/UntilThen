 ...
 *
 * showBack / showSettings let TopNav hide the back and account
 * buttons for signed-out viewers, leaving just the Home button
 * pointing at the public landing — appropriate on the marketing
 * surfaces (/weddings, /business, /capsules/new) where there's
 * no account to manage and "back" can bounce a visitor off-site.
 */
