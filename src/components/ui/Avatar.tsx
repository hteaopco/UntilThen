  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        disabled={!isLoaded}
        className="w-9 h-9 rounded-full bg-navy text-white text-[13px] font-bold tracking-[0.02em] flex items-center justify-center hover:opacity-85 transition-opacity focus:outline-none focus:ring-2 focus:ring-sky/40 disabled:opacity-50"
      >
        {initials}
      </button>
